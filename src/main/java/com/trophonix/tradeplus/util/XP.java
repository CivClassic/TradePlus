...
public class XP {
	 ...
	 *
	 * <p>http://minecraft.gamepedia.com/Experience#Leveling_up
	 *
	 * <p>"One can determine how much experience has been collected to reach a level using the
	 * equations:
	 *
	 * <p>Total Experience = [Level]2 + 6[Level] (at levels 0-15) 2.5[Level]2 - 40.5[Level] + 360 (at
	 ...
	 * are as follows: Experience Required = 2[Current Level] + 7 (at levels 0-15) 5[Current Level] -
	 * 38 (at levels 16-30) 9[Current Level] - 158 (at level 31+)"
	 */
