...
public class TokenManagerExtra extends Extra {
	...
	public ItemStack _getIcon(Player player) {
		return ItemFactory.replaceInMeta(icon, "%AMOUNT%", Long.toString((long) (player.equals(player1) ? value1 : value2)), "%INCREMENT%", Long
				.toString((long) increment), "%PLAYERINCREMENT%", Long.toString((long) (player.equals(player1) ? increment1 : increment2)));
	}
