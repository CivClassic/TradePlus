...
public class TradePlusPlugin extends ACivMod {

	@Getter
	private static TradePlusPlugin instance;
	...
	public void onEnable() {
		...
		taskFactory.newChain().async(tradeConfig::load).async(tradeConfig::update).sync(() -> {
